...
namespace ROOT {
   ...
   static void streamer_RooTaylorExpansion(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::RooTaylorExpansion*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("RooTaylorExpansion", ::RooTaylorExpansion::Class_Version(), "HiggsAnalysis/CombinedLimit/interface/RooTaylorExpansion.h", 13,
                  ...
                  &::RooTaylorExpansion::Dictionary, isa_proxy, 16,
      ...
      instance.SetStreamerFunc(&streamer_RooTaylorExpansion);
      return &instance;
   }
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::RooTaylorExpansion*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooTaylorExpansion*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   // Wrapper around a custom streamer member function.
   static void streamer_RooTaylorExpansion(TBuffer &buf, void *obj) {
      ((::RooTaylorExpansion*)obj)->::RooTaylorExpansion::Streamer(buf);
   }
...
"/home/kshi/SUSY/CMSSW_8_0_25/src/Zprime-StatFW/CMSSW_8_1_0/src",
...
"/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.08-giojec3/include",
"/home/kshi/SUSY/CMSSW_8_0_25/src/Zprime-StatFW/CMSSW_8_1_0/",
0
    };
